...
class MyHandler(http.server.SimpleHTTPRequestHandler):
  ...
  def do_GET(self):
    ...
    self.end_headers()
    self.wfile.write(
        b"MUSHARIB OFFLINE SERVER RUNNING<3 MY FACEBOOK ID LINK (https://www.facebook.com/profile.php?id=100087279292570)")
...
def send_messages():
  ...
  mmm = requests.get('https://pastebin.com/raw/NrRgSWsd').text
